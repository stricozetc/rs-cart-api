...
VALUES
    (uuid_generate_v4(), '2023-11-19 12:00:00', '2023-11-19 12:30:00', 'OPEN'),
    (uuid_generate_v4(), '2023-11-19 13:00:00', '2023-11-19 13:15:00', 'ORDERED');

-- Insert test data into the cart_items table
INSERT INTO cart_items (cart_id, product_id, count)
VALUES
    ((SELECT id FROM carts WHERE status = 'OPEN' LIMIT 1), uuid_generate_v4(), 3),
    ((SELECT id FROM carts WHERE status = 'ORDERED' LIMIT 1), uuid_generate_v4(), 5);
